      ...
      <View style={{ position: 'absolute', left: 16, right: 74, bottom: 24 }}>
        <View style={{ flexDirection: 'row', alignItems: 'center', gap: 9 }}>
          ...
          <Press scale={0.9} onPress={onFollow} label={following ? 'Following' : 'Follow'}>
            <View style={{ height: 28, paddingHorizontal: 13, borderRadius: 14, backgroundColor: following ? 'rgba(255,255,255,.16)' : c.primaryD, borderWidth: following ? 1 : 0, borderColor: 'rgba(255,255,255,.45)', alignItems: 'center', justifyContent: 'center' }}>
        ...
        {f.mealOrderable && f.mealId ? (
          <Press scale={0.98} onPress={() => { recordFeedEvent(f.id, 'open_meal'); router.push(`/meal/${f.mealId}`); }} style={{ marginTop: 14 }}>
            <View style={{ flexDirection: 'row', alignItems: 'center', gap: 11, padding: 8, paddingLeft: 12, borderRadius: radius.lg, backgroundColor: 'rgba(255,255,255,.14)', borderWidth: 1, borderColor: 'rgba(255,255,255,.22)' }}>
              ...
              <View style={{ height: 38, paddingHorizontal: 16, borderRadius: radius.pill, backgroundColor: c.primaryD, flexDirection: 'row', alignItems: 'center', gap: 6 }}>
  ...
  return (
    <Press scale={0.85} onPress={onPress}>
      <View style={{ alignItems: 'center', gap: 5 }}>
        <View style={{ width: 46, height: 46, borderRadius: 23, backgroundColor: active ? c.primaryD : 'rgba(0,0,0,.32)', alignItems: 'center', justifyContent: 'center' }}>
