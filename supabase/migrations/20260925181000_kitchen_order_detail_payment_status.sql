-- Give the assigned kitchen the authoritative payment state used to gate fulfillment.
...
as $body$
  select o.id, o.customer_id, p.display_name, o.status::text, o.pay_status::text, o.fulfillment::text,
    o.delivery_address_text, o.delivery_instructions, o.method::text,
